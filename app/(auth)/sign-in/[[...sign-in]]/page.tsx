    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden text-foreground">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 opacity-10 pointer-events-none">
                <Image src="/background-ornaments/1.png" alt="ornament" fill className="object-contain rotate-180" />
            </div>
            <div className="absolute bottom-0 left-0 w-64 h-64 opacity-10 pointer-events-none">
                <Image src="/background-ornaments/1.png" alt="ornament" fill className="object-contain" />
            </div>
                ...
                <SignIn
                    appearance={{
                        elements: {
                            ...
                            socialButtonsBlockButton: "bg-secondary border border-border hover:bg-muted transition-all text-foreground",
