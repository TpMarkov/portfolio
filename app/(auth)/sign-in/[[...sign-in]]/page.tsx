                    ...
                    <SignIn
                        appearance={{
                            ...
                            elements: {
                                ...
                                formFieldInput: "bg-secondary/50 border-none focus:ring-2 focus:ring-primary/50 transition-all rounded-none h-10 sm:h-10 px-5 sm:px-6 italic font-bold text-sm sm:text-base",
