...
export default function Page() {
    ...
    return (
        <div className="calc-(min-h-screen-25) flex flex-col lg:flex-row bg-background text-foreground transition-colors duration-300 overflow-x-hidden">
            ...
            <div className="hidden lg:flex lg:w-2/3 relative overflow-hidden bg-slate-950">
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 via-transparent to-slate-950" />
                ...
                <div className="relative z-10 flex flex-col justify-between h-full w-full p-16">
                    ...
                    <div className="space-y-6 max-w-lg">
                        ...
                        <p className="text-slate-200 font-semibold text-xl italic leading-relaxed backdrop-blur-sm bg-black/10 p-6 rounded-3xl border-l-4 border-primary">
                            "Join the club of digital architects making a difference. Premium tools for premium developers."
                        </p>
                    </div>

                    <div className="text-slate-400 font-bold text-xs uppercase tracking-[0.3em] italic text-white">
                        © 2026 webdevstudioHQ — premium digital systems
                    </div>
                </div>
            </div>
                    ...
                    <SignUp
                        appearance={{
                            ...
                            elements: {
                                ...
                                formButtonPrimary: "bg-primary hover:bg-primary/90 text-sm font-black uppercase tracking-widest italic shadow-xl shadow-primary/20 h-14 transition-all rounded-2xl border-none",
                                socialButtonsBlockButton: "border-border hover:bg-muted transition-all rounded-2xl h-14 bg-secondary/50",
